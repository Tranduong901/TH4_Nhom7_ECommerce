...
class _ProductDetailScreenState extends State<ProductDetailScreen> {
  ...
  void initState() {
    super.initState();
    // For demo use same image in list; replace with product.images if available
    _images = [
  ...
  void _showAddToCartSheet({bool goToCheckout = false}) {
                ...
                child: ElevatedButton(
                  onPressed: () {
                    context.read<CartProvider>().addToCart(
                        widget.product, selectedSize, selectedColor, quantity);
                    Navigator.pop(ctx);
                    if (!goToCheckout) {
  ...
  Widget build(BuildContext context) {
    final originalPrice = (widget.product.price * 1.5).toStringAsFixed(2);
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            // Image Slider with Hero on first image
            Container(
              color: Colors.white,
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(children: [
                    ...
                    const SizedBox(width: 8),
                    Text('Đã bán ${widget.product.rating.count}',
                        style:
            ...
            const SizedBox(height: 8),
            // Description with 5-line collapse
            Container(
              color: Colors.white,
              width: double.infinity,
              padding: const EdgeInsets.all(16.0),
                  ...
                  children: [
                    ...
                    LayoutBuilder(
                      builder: (context, constraints) {
                        ...
                        final isOverflow = measure.didExceedMaxLines;
      ...
      bottomNavigationBar: Container(
        ...
        child: Row(
          children: [
            ...
            Expanded(
              child: GestureDetector(
                ...
                child: Container(
                  ...
                  color: Colors.blue[50],
                  alignment: Alignment.center,
                  child: const Text('THÊM VÀO GIỎ MUA',
                      style: TextStyle(
                          color: Colors.blueAccent,
                          fontWeight: FontWeight.bold,
                          fontSize: 13)),
            ...
            Expanded(
              child: GestureDetector(
                onTap: () => _showAddToCartSheet(goToCheckout: true),
                child: Container(
                  height: 56,
                  color: Colors.blueAccent,
                  alignment: Alignment.center,
